...
from nmf_elastic_o import NMF_logistic
...
yhat_tr = np.squeeze(np.dot(S_train[:,:2],phi))
yhat_te = np.squeeze(np.dot(S_test[:,:2],phi))
...
print('>>>>>>>>>>>>>>>>')
print('Training ROC T',roc_auc_score(y_train,yhat_tr))
print('Testing ROC T',roc_auc_score(y_test,yhat_te))
...
print('>>>>>>>>>>>>>>>>')
print('ROC1',roc_auc_score(y_test[idx1],yhat_te[idx1]))
print('ROC2',roc_auc_score(y_test[idx2],yhat_te[idx2]))
print('ROC3',roc_auc_score(y_test[idx3],yhat_te[idx3]))
...
myDict['rTest1_T'] = roc_auc_score(y_test[idx1],yhat_te[idx1])
myDict['rTest2_T'] = roc_auc_score(y_test[idx2],yhat_te[idx2])
myDict['rTest3_T'] = roc_auc_score(y_test[idx3],yhat_te[idx3])
...
pname = 'Unbalanced_Orthogonal_12_enc_' + str(mu) + '.p'
