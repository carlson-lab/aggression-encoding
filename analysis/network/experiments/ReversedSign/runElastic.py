...
def roc_auc_score(y_true,y_pred):
    pred_true = y_pred[y_true==1]
    pred_false = y_pred[y_true==0]
    U,pval = mannwhitneyu(pred_true,pred_false)
    myAUC = U/(len(pred_true)*len(pred_false))
    return myAUC
...
pname = 'Unbalanced_Positive_12_enc_' + str(mu) + '.p'
