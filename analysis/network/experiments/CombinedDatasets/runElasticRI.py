...
from nmf_log_ri import NMF_logistic
...
nIter = 20#000
oneHot = np.zeros((X_train_tot.shape[0],5))
oneHot[:100,0] = 1
oneHot[100:200,1] = 1
oneHot[200:300,2] = 1
oneHot[300:400,3] = 1
...
S_train = model.fit_transform(X_train_tot,y_train_tot,oneHot)
...
pname = 'Unbalanced_Elastic_12_encRI_' + str(mu) + '.p'
