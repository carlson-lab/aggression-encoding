...
from nmf_logistic import NMF_logistic
...
S_train,encoder = model.fit_transform(X_train_tot,y_train_tot,weights_s=weights_s,
                            weights_g=weights_g)
...
sname = './checkpoints/Model_log_' + str(int(100*mu))
...
pname = 'Unbalanced_Log_12_enc_' + str(int(100*mu)) + '.p'
