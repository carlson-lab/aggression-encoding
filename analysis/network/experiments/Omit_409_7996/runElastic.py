...
remove_idx = (mouse=='Mouse7996')|(mouse=='Mouse049')
keep_idx = remove_idx == False

power = power[keep_idx]
coherence = coherence[keep_idx]
granger = granger[keep_idx]
mouse = mouse[keep_idx]
group = group[keep_idx]
expDate = expDate[keep_idx]
behavior = behavior[keep_idx]
behaviornon1 = behaviornon1[keep_idx]
time = time[keep_idx]
...
pname = 'Unbalanced_Elastic_12_enc_Omit_' + str(mu) + '.p'
