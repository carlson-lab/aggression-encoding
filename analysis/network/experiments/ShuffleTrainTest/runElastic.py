...
mice_original = np.unique(mouse)
choice_1 = rand.choice(len(mice_original),3,replace=False)

#training_set_idx[mouse=='Mouse048'] = 0
#training_set_idx[mouse=='Mouse7980'] = 0
#training_set_idx[mouse=='Mouse7998'] = 0
training_set_idx[mouse==mice_original[choice_1[0]]] = 0
training_set_idx[mouse==mice_original[choice_1[1]]] = 0
training_set_idx[mouse==mice_original[choice_1[2]]] = 0
#training_set_idx[mouse=='Mouse7980'] = 0
#training_set_idx[mouse=='Mouse7998'] = 0
...
pname = 'Unbalanced_Elastic_12_enc_' + str(seednum) + '.p'
